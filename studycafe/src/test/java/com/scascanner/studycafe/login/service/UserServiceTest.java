...
public class UserServiceTest{
    ...
    public void 회원가입() throws Exception{
        ...
        //then
        Assertions.assertEquals(userRepository.findByName(name).get(0), userRepository.findById(savedId).get());
    }
    ...
    public void 이메일로찾기() throws Exception{
        ...
        //then
        Assertions.assertEquals(userRepository.findById(savedId).get(), userByEmail);
    }
}
